...
public class ShardingConfig {
    ...
    private TableRuleConfiguration userRuleConfig() {
        // 配置user表规则
        TableRuleConfiguration tableRuleConfig = new TableRuleConfiguration("t_user", "ds${0..1}.t_user${0..1}");
        KeyGeneratorConfiguration keyGeneratorConfiguration = new KeyGeneratorConfiguration("String", "id");
    ...
    private TableRuleConfiguration addressRuleConfig() {
        // 配置address表规则
        TableRuleConfiguration tableRuleConfig = new TableRuleConfiguration("t_address", "ds${0..1}.t_address");
        KeyGeneratorConfiguration keyGeneratorConfiguration = new KeyGeneratorConfiguration("String", "id");
        tableRuleConfig.setKeyGeneratorConfig(keyGeneratorConfiguration);
        // 配置分库 + 分表策略
